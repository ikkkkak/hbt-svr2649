...
type HabitatPlot struct {
	...
	SectorID         uint           `json:"sector_id" gorm:"not null;index:idx_habitat_plots_sector;constraint:OnUpdate:CASCADE,OnDelete:CASCADE"`
	PlotNumber       string         `json:"plot_number" gorm:"size:100;not null;uniqueIndex:unique_plot_per_sector,composite:sector_id"`
